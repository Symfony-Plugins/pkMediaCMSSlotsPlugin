...
class pkContextCMSMediaBrowserActions extends pkContextCMSBaseActions
{
  public function executeEdit(sfRequest $request)
  {
    $this->logMessage("====== in pkContextCMSMediaBrowserActions::executeEdit", "info");
    $this->editSetup();
    $this->form = new pkContextCMSMediaBrowserEditForm();
    $this->form->setId($this->id);
    $this->form->bind($request->getParameter("pk-mediabrowser-edit-form-" . $this->id));
