...
class pkContextCMSMediaBrowserComponents extends pkContextCMSBaseComponents
{
  protected function valueSetup()
  {
    ...
    if (is_array($value))
    {
      ...
      {
        $this->browseParams['limit'] = sfConfig::get('app_pkMediaCMSSlots_mediaBrowser_limit', 10);
      }
    }
